...
!(function (e, t) {
      ...
      (te = se._dc =
        ...
        (se.disable = function () {
          se.isEnabled &&
            ...
            se.isPressed && (se._vx.reset(), se._vy.reset(), C(z ? i : ve, De[1], We, !0)),
  ...
  function Db() {
    ze.cache++, nt || h || je.fullscreenElement || je.webkitFullscreenElement || (b && y === Je.innerWidth && !(Math.abs(Je.innerHeight - m) > 0.25 * Je.innerHeight)) || c.restart(!0);
  }
  function Gb() {
  ...
  var He,
    ...
    Mt = function _getBounds(e, t) {
      var r = t && "matrix(1, 0, 0, 1, 0, 0)" !== eb(e)[f] && He.to(e, { x: 0, y: 0, xPercent: 0, yPercent: 0, rotation: 0, rotationX: 0, rotationY: 0, scale: 1, skewX: 0, skewY: 0 }).progress(1),
    ...
    Q =
      ((ScrollTrigger.prototype.init = function init(S, C) {
        if (((this.progress = this.start = 0), this.vars && this.kill(!0, !0), vt)) {
          var E,
            ...
            T,
            i,
            Q = (S = gb(Ka(S) || Ma(S) || S.nodeType ? { trigger: S } : S, Ot)).onUpdate,
            ee = S.toggleClass,
            a = S.id,
            te = S.onToggle,
            re = S.onRefresh,
          ...
          if (
            ...
            (Te.vars = S),
            (C = C || S.animation),
            "refreshPriority" in S && ((at = 1), -9999 === S.refreshPriority && (pt = Te)),
            (c.tweenScroll = c.tweenScroll || { top: fc(be, Ke), left: fc(be, Xe) }),
            ...
            C &&
              ((C.vars.lazy = !1), C._initted || (!1 !== C.vars.immediateRender && !1 !== S.immediateRender && C.duration() && C.render(0, !0, !0)), (Te.animation = C.pause()), (C.scrollTrigger = Te).scrubDuration(ne), (w = 0), (a = a || C.vars.id)),
            At.push(Te),
            ue &&
              ((Na(ue) && !ue.push) || (ue = { snapTo: ue }),
              "scrollBehavior" in Ge.style && He.set(me ? [Ge, qe] : be, { scrollBehavior: "auto" }),
              ze.forEach(function (e) {
                  ...
                  if (e <= O && P <= e && c !== e) {
                    ...
                    !1 === ue.inertia && (a = l - n),
                      E(
                        c,
                        {
                          duration: g(bt((0.185 * Math.max(bt(s - o), bt(l - o))) / i / 0.05 || 0)),
                          ease: ue.ease || "power3",
                          data: bt(c - e),
            ...
            ie &&
              (!1 === ae || ae === Ct || (ae = !(!ae && ie.parentNode && ie.parentNode.style && "flex" === eb(ie.parentNode).display) && St),
              (Te.pin = ie),
              (n = He.core.getCache(ie)).spacer
                ? (R = n.pinState)
                : (l && ((l = J(l)) && !l.nodeType && (l = l.current || l.nativeElement), (n.spacerIsNative = !!l), l && (n.spacerState = _b(l))),
          ...
          (Te.previous = function () {
            ...
            (Te.revert = function (e, t) {
              ...
              var r = !1 !== e || !Te.enabled,
                n = nt;
              r !== Te.isReverted &&
                (r && ((Z = Math.max(Pe(), Te.scroll.rec || 0)), (G = Te.progress), ($ = C && C.progress())),
                A &&
            ...
            (Te.refresh = function (e, t) {
              if ((!nt && Te.enabled) || t)
                if (ie && e && ht) ob(ScrollTrigger, "scrollEnd", Gb);
                  ...
                  !ut && Se && Se(Te), (nt = 1), (Me = gt()), E.tween && (E.tween.kill(), (E.tween = 0)), q && q.pause(), se && C && C.revert({ kill: !1 }).invalidate(), Te.isReverted || Te.revert(!0, !0), (Te._subPinOffset = !1);
                  for (
                    var r,
                      n,
                      o,
                      ...
                      m = S.end,
                      y = S.endTrigger || oe,
                      x = S.start || (0 !== S.start && oe ? (ie ? "0 0" : "0 100%") : 0),
                      w = (Te.pinnedContainer = S.pinnedContainer && J(S.pinnedContainer)),
                  ...
                  for (
                    La(x) && (x = x(Te)),
                      P = cc(x, oe, d, he, Pe(), A, D, Te, g, _e, ye, h, pe) || (ie ? -0.001 : 0),
                      La(m) && (m = m(Te)),
                      Ka(m) && !m.indexOf("+=") && (~m.indexOf(" ") ? (m = (Ka(x) ? x.split(" ")[0] : "") + m) : ((v = ub(m.substr(2), d)), (m = Ka(x) ? x : P + v), (y = oe))),
                      O = Math.max(P, cc(m || (y ? "100% 0" : h), y, d, he, Pe() + v, B, I, Te, g, _e, ye, h, pe)) || -0.001,
                      L = O - P || ((P -= 0.01) && 0.001),
                      v = 0,
                      T = _;
                    T--;
                  ...
                  if (((P += v), (O += v), (Te._pinPush = b), A && v && (((r = {})[he.a] = "+=" + v), w && (r[he.p] = "-=" + Pe()), He.set([A, B], r)), ie))
                    (r = eb(ie)),
                      (i = he === Ke),
                      (o = Pe()),
                      (W = parseFloat(X(he.a)) + b),
                      !h && 1 < O && ((p = { style: (p = (me ? je.scrollingElement || qe : be).style), value: p["overflow" + he.a.toUpperCase()] })["overflow" + he.a.toUpperCase()] = "scroll"),
                      Yb(ie, N, r),
                      (F = _b(ie)),
                      (n = Mt(ie, !0)),
                      (c = ye && K(be, i ? Xe : Ke)()),
                      ae &&
                        ...
                        ye && Pe(Z)),
                      ye &&
                        (((a = { top: n.top + (i ? o - P : c) + kt, left: n.left + (i ? c : o - P) + kt, boxSizing: "border-box", position: "fixed" })[mt] = a.maxWidth = Math.ceil(n.width) + kt),
            ...
            (Te.update = function (e, t, r) {
              if (!pe || r || e) {
                ...
                if ((t && ((M = k), (k = pe ? Pe() : u), ue && ((_ = w), (w = C && !ve ? C.totalProgress() : p))), le && !p && ie && !nt && !dt && ht && P < u + ((u - M) / (gt() - rt)) * le && (p = 1e-4), p !== d && Te.enabled)) {
                  if (
                    ((a = (s = (n = Te.isActive = !!p && p < 1) != (!!d && d < 1)) || !!p != !!d),
                    (Te.direction = d < p ? 1 : -1),
                    (Te.progress = p),
                    a && !nt && ((o = p && !d ? 0 : 1 === p ? 1 : 1 === d ? 2 : 3), ve && ((i = (!s && "none" !== we[o + 1] && we[o + 1]) || we[o]), (c = C && ("complete" === i || "reset" === i || i in C)))),
                    ge &&
                      (s || c) &&
                      (c || ne || !C) &&
                      (La(ge)
                    ...
                    ve ||
                      (!q || nt || dt
                        ...
                        : (q._dp._time - q._start !== q._time && q.render(q._dp._time - q._start), q.resetTo ? q.resetTo("totalProgress", p, C._tTime / C._tDur) : ((q.vars.totalProgress = p), q.invalidate().restart()))),
                    ie)
                  )
                  ...
                  !ue || E.tween || nt || dt || V.restart(!0),
                    ...
                    !Q || ve || e || Q(Te),
                    a && !nt
                      ? (ve && (c && ("complete" === i ? C.pause().totalProgress(1) : "reset" === i ? C.restart(!0).pause() : "restart" === i ? C.restart(!0) : C[i]()), Q && Q(Te)),
                        (!s && ct) || (te && s && Pa(Te, te), xe[o] && Pa(Te, xe[o]), ce && (1 === p ? Te.kill(!1, 1) : (xe[o] = 0)), s || (xe[(o = 1 === p ? 1 : 3)] && Pa(Te, xe[o]))),
                        de && !n && Math.abs(Te.getVelocity()) > (Ma(de) ? de : 2500) && (Oa(Te.callbackAnimation), q ? q.progress(1) : Oa(C, "reverse" === i ? 1 : !p, 1)))
                      : ve && Q && !nt && Q(Te);
                }
                if (x) {
            ...
            (Te.disable = function (e, t) {
              if (
                Te.enabled &&
                (!1 !== e && Te.revert(!0, !0), (Te.enabled = Te.isActive = !1), t || (q && q.pause()), (Z = 0), n && (n.uncache = 1), Se && pb(ScrollTrigger, "refreshInit", Se), V && (V.pause(), E.tween && E.tween.kill() && (E.tween = 0)), !me)
              ) {
      ...
      (ScrollTrigger.enable = function enable() {
        if (
          ...
          (Ge = je.body),
          He && ((et = He.utils.toArray), (tt = He.utils.clamp), (lt = He.core.context || Aa), (st = He.core.suppressOverwrites || Aa), (x = Je.history.scrollRestoration || "auto"), He.core.globals("ScrollTrigger", ScrollTrigger), Ge))
        ) {
          (vt = 1),
            E.register(He),
  ...
  function pc(e) {
    ...
    return (
        ...
        function (e, t) {
          if ((v.offset && Ip(), t)) {
            ...
            var r,
              n,
              o = w();
            f && ((n = (r = b()) + (0.05 * o * -e.velocityX) / 0.227), (o *= hc(b, r, n, Ia(p, Xe))), (a.vars.scrollX = T(n))),
              (n = (r = v()) + (0.05 * o * -e.velocityY) / 0.227),
              (o *= hc(v, r, n, Ia(p, Ke))),
              (a.vars.scrollY = S(n)),
              a.invalidate().duration(o).play(0.01),
              ((k && a.vars.scrollY >= i) || i - 1 <= r) && He.to({}, { onUpdate: Op, duration: o });
          } else s.restart(!0);
        }),
      (e.onWheel = function () {
      ...
      k && He.ticker.add(Aa),
      (s = n._dc),
      (a = He.to(n, { ease: "power4", paused: !0, scrollX: f ? "+=0.1" : "+=0", scrollY: "+=0.1", onComplete: s.vars.onComplete })),
      n
    );
  }
  var ee,
