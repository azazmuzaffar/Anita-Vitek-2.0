...
!(function (t, e) {
  ...
  function lb(t, e, r) {
    ...
    if (!_) {
      if (("," === t.substr(-1) && (t = t.substr(0, t.length - 1)), Ot[t])) _ = Ot[t];
        ...
        } else (s = (+_[0] % 360) / 360), (o = _[1] / 100), (i = 2 * (u = _[2] / 100) - (n = u <= 0.5 ? u * (o + 1) : u + o - u * o)), 3 < _.length && (_[3] *= 1), (_[0] = kb(s + 1 / 3, i, n)), (_[1] = kb(s, i, n)), (_[2] = kb(s - 1 / 3, i, n));
        ...
        return arguments.length
          ? (this._ps !== t &&
              ((this._ps = t)
                ...
                : (Pt(), (this._ts = this._rts), this.totalTime(this.parent && !this.parent.smoothChildTiming ? this.rawTime() : this._tTime || this._pTime, 1 === this.progress() && (this._tTime -= U) && Math.abs(this._zTime) !== U))),
            this)
          : this._ps;
      }),
        ...
        (t.render = function render(t, e, r) {
          ...
          if (_) {
            if (c !== this._tTime || !t || r || (this._startAt && this._zTime < 0 != t < 0)) {
              ...
              for (
                this._tTime = c, this._time = i, !this._act && this._ts && ((this._act = 1), (this._lazy = 0)), this.ratio = h = (f || this._ease)(i / _), this._from && (this.ratio = h = 1 - h), !i || d || e || xt(this, "onStart"), n = this._pt;
                n;
  ...
  _(
    ct + "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",
    function (t) {
      return (ut[t] = 1);
    }
  ),
    ...
    Qe = function _parseTransform(t, e) {
      ...
      return (
        ...
        m !== Ze &&
          ...
          (n = O = m[5]),
          6 === m.length
            ? ((s = Math.sqrt(T * T + b * b)), (o = Math.sqrt(x * x + w * w)), (u = T || b ? Ee(b, T) * Fe : 0), (f = w || x ? Ee(w, x) * Fe + u : 0) && (o *= Math.cos(f * Re)), r.svg && ((i -= _ - (_ * T + c * w)), (n -= c - (_ * b + c * x))))
            : ((R = m[6]),
              (z = m[7]),
              (P = m[8]),
              (D = m[9]),
              ...
              (a = m[14]),
              (h = (g = Ee(R, S)) * Fe),
              g && ((M = k * (v = Math.cos(-g)) + P * (y = Math.sin(-g))), (C = O * v + D * y), (A = R * v + S * y), (P = k * -y + P * v), (D = O * -y + D * v), (S = R * -y + S * v), (F = z * -y + F * v), (k = M), (O = C), (R = A)),
              (l = (g = Ee(-w, S)) * Fe),
