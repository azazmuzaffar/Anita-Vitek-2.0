!(function (t, e) {
        ...
        polyfill: function () {
          ...
          if (!("scrollBehavior" in c.documentElement.style && !0 !== a.__forceSmoothScrollPolyfill__)) {
            var t,
              ...
              l = 468,
              h = { scroll: a.scroll || a.scrollTo, scrollBy: a.scrollBy, elementScroll: e.prototype.scroll || d, scrollIntoView: e.prototype.scrollIntoView },
            ...
            (a.scroll = a.scrollTo =
              function () {
                void 0 !== arguments[0] &&
                  (!0 !== s(arguments[0])
                    ? r.call(a, c.body, void 0 !== arguments[0].left ? ~~arguments[0].left : a.scrollX || a.pageXOffset, void 0 !== arguments[0].top ? ~~arguments[0].top : a.scrollY || a.pageYOffset)
                    : h.scroll.call(
                        a,
                        void 0 !== arguments[0].left ? arguments[0].left : "object" != typeof arguments[0] ? arguments[0] : a.scrollX || a.pageXOffset,
                        void 0 !== arguments[0].top ? arguments[0].top : void 0 !== arguments[1] ? arguments[1] : a.scrollY || a.pageYOffset
                      ));
              }),
              (a.scrollBy = function () {
                void 0 !== arguments[0] &&
                  (s(arguments[0])
                    ? h.scrollBy.call(a, void 0 !== arguments[0].left ? arguments[0].left : "object" != typeof arguments[0] ? arguments[0] : 0, void 0 !== arguments[0].top ? arguments[0].top : void 0 !== arguments[1] ? arguments[1] : 0)
                    : r.call(a, c.body, ~~arguments[0].left + (a.scrollX || a.pageXOffset), ~~arguments[0].top + (a.scrollY || a.pageYOffset)));
              }),
              ...
              (e.prototype.scrollIntoView = function () {
                if (!0 !== s(arguments[0])) {
                  ...
                  t !== c.body
                    ? (r.call(this, t, t.scrollLeft + i.left - e.left, t.scrollTop + i.top - e.top), "fixed" !== a.getComputedStyle(t).position && a.scrollBy({ left: e.left, top: e.top, behavior: "smooth" }))
                    : a.scrollBy({ left: i.left, top: i.top, behavior: "smooth" });
          ...
          function r(t, e, i) {
            var s,
              ...
              l,
              r = u();
            (l = t === c.body ? ((n = (s = a).scrollX || a.pageXOffset), (o = a.scrollY || a.pageYOffset), h.scroll) : ((n = (s = t).scrollLeft), (o = t.scrollTop), d)), f({ scrollable: s, method: l, startTime: r, startX: n, startY: o, x: e, y: i });
          }
        },
      };
    }),
    m =
      ...
      (function (t) {
        function i() {
          ...
          return s(this, i), (t = h(this, r(i).call(this, e))), window.addEventListener("scroll", t.checkScroll, !1), y.polyfill(), t;
        }
        return (
          l(i, f),
          o(i, [
                ...
                (this.els = []),
                  this.el.querySelectorAll("[data-" + this.name + "]").forEach(function (t, e) {
                    ...
                    var a = h.getRelativeOffset(o),
                      c = { el: t, id: e, class: i, top: s + a[0], bottom: n - a[1], offset: o, repeat: l, inView: !!t.classList.contains(i), call: r };
                    h.els.push(c);
                  });
              },
            },
            ...
            },
            {
              ...
              value: function (t, e, i, s, n, o) {
                ...
                if ("string" == typeof t) {
                  ...
                  else if ("bottom" === t) l = this.html.offsetHeight - window.innerHeight;
          ...
          return (
            (t.prototype.check = function (t) {
              ...
              return (
                ...
                0 < e ? (this.lastUpDeltas.push(e), this.lastUpDeltas.shift(), this.isInertia(1)) : (this.lastDownDeltas.push(e), this.lastDownDeltas.shift(), this.isInertia(-1))
              );
            }),
  ...
  function P(t) {
    !(function (t) {
      ...
      if (0 === e.length) for (var i in t) L.call(t, i) && "function" == typeof t[i] && "[object Function]" == D.call(t[i]) && e.push(i);
      ...
      (this.options = S({ mouseMultiplier: 1, touchMultiplier: 2, firefoxMultiplier: 15, keyStep: 120, preventTouch: !1, unpreventTouchClass: "vs-touchmove-allowed", limitInertia: !1, useKeyboard: !0, useTouch: !0 }, t)),
  ...
  function X(t) {
    ...
    if (window.getComputedStyle) {
      var i = getComputedStyle(t),
        ...
        n = s.match(/^matrix3d\((.+)\)$/);
      return (
        n ? ((e.x = n ? parseFloat(n[1].split(", ")[12]) : 0), (e.y = n ? parseFloat(n[1].split(", ")[13]) : 0)) : ((n = s.match(/^matrix\((.+)\)$/)), (e.x = n ? parseFloat(n[1].split(", ")[4]) : 0), (e.y = n ? parseFloat(n[1].split(", ")[5]) : 0)),
        e
      );
    }
  }
  ...
  (P.prototype._notify = function (t) {
    var e = this._event;
    (e.x += e.deltaX), (e.y += e.deltaY), this._emitter.emit(x, { x: e.x, y: e.y, deltaX: e.deltaX, deltaY: e.deltaY, originalEvent: t });
  }),
    (P.prototype._onWheel = function (t) {
      ...
      if (!this._lethargy || !1 !== this._lethargy.check(t)) {
        ...
        (i.deltaX = t.wheelDeltaX || -1 * t.deltaX),
          ...
          O.isFirefox && 1 == t.deltaMode && ((i.deltaX *= e.firefoxMultiplier), (i.deltaY *= e.firefoxMultiplier)),
    ...
    (P.prototype._bind = function () {
      O.hasWheelEvent && this.el.addEventListener("wheel", this._onWheel, this.listenerOptions),
        ...
        O.hasTouch && this.options.useTouch && (this.el.addEventListener("touchstart", this._onTouchStart, this.listenerOptions), this.el.addEventListener("touchmove", this._onTouchMove, this.listenerOptions)),
        O.hasPointer &&
          O.hasTouchWin &&
          ((this.bodyTouchAction = document.body.style.msTouchAction), (document.body.style.msTouchAction = "none"), this.el.addEventListener("MSPointerDown", this._onTouchStart, !0), this.el.addEventListener("MSPointerMove", this._onTouchMove, !0)),
  ...
  var J = function (o, e, l, i) {
      ...
      if (o === e && l === i) return G;
      for (var r = q ? new Float32Array(11) : new Array(11), t = 0; t < 11; ++t) r[t] = U(0.1 * t, o, l);
      function s(t) {
    ...
    lt = (function (t) {
      function n() {
        ...
        return (
          ...
          (t = h(this, r(n).call(this, e))).inertia && (t.lerp = 0.1 * t.inertia),
          (t.isScrolling = !1),
            ...
            value: function () {
              ...
              this.html.classList.add(this.smoothClass),
                ...
                (this.vs = new C({
                  ...
                  mouseMultiplier: -1 < navigator.platform.indexOf("Win") ? 1 : 0.4,
          ...
          },
          {
            ...
            value: function () {
              ...
              if ((0 < arguments.length && void 0 !== arguments[0] && arguments[0]) || this.isScrolling || this.isDraggingScrollbar) {
                ...
                !this.animatingScroll && ((e < 0.5 && 0 != this.instance.delta.y) || (e < 0.5 && 0 == this.instance.delta.y)) && this.stopScrolling();
                for (var i = this.sections.length - 1; 0 <= i; i--)
                  this.sections[i].persistent || (this.instance.scroll.y > this.sections[i].offset && this.instance.scroll.y < this.sections[i].limit)
                    ? (this.transform(this.sections[i].el, 0, -this.instance.scroll.y),
                      this.sections[i].inView ||
                        ((this.sections[i].inView = !0), (this.sections[i].el.style.opacity = 1), (this.sections[i].el.style.pointerEvents = "all"), this.sections[i].el.setAttribute("data-".concat(this.name, "-section-inview"), "")))
                    : (this.sections[i].inView &&
                        ((this.sections[i].inView = !1), (this.sections[i].el.style.opacity = 0), (this.sections[i].el.style.pointerEvents = "none"), this.sections[i].el.removeAttribute("data-".concat(this.name, "-section-inview"))),
          ...
          },
          {
            ...
            value: function (t) {
              this.isScrolling || this.isDraggingScrollbar
                ? (this.instance.scroll.y = R(this.instance.scroll.y, this.instance.delta.y, this.lerp))
              ...
              (this.els = []),
                ...
                this.sections.forEach(function (t, S) {
                  k.sections[S].el.querySelectorAll("[data-".concat(k.name, "]")).forEach(function (t, e) {
                    ...
                    var p = (i = k.sections[S].inView ? s.getBoundingClientRect().top + k.instance.scroll.y - X(s).y : s.getBoundingClientRect().top - X(k.sections[S].el).y - X(s).y) + s.offsetHeight,
                      y = (p - i) / 2 + i;
                    if (h) {
                    ...
                    var g = [0, 0];
                    if (d) for (var w = 0; w < d.length; w++) "string" == typeof d[w] ? (d[w].includes("%") ? (g[w] = parseInt((d[w].replace("%", "") * k.windowHeight) / 100)) : (g[w] = parseInt(d[w]))) : (g[w] = d[w]);
                    var b = { el: t, id: e, class: n, top: i + g[0], middle: y, bottom: p - g[1], offset: d, repeat: o, inView: !!t.classList.contains(n), call: l, speed: u, delay: a, position: r, target: s, direction: c, sticky: h };
            ...
            value: function () {
              ...
              0 === t.length && (t = [this.el]),
                t.forEach(function (t, e) {
                  var i = t.getBoundingClientRect().top - 1.5 * window.innerHeight - X(t).y,
                    s = i + t.getBoundingClientRect().height + 2 * window.innerHeight,
                    n = { el: t, offset: i, limit: s, inView: !1, persistent: "string" == typeof t.dataset[o.name + "Persistent"] };
                  o.sections[e] = n;
                });
            },
          },
              ...
              this.parallaxElements.forEach(function (t, e) {
                ...
                t.sticky &&
                  (i = t.inView
                    ...
                    : n.instance.scroll.y < t.top - window.innerHeight && n.instance.scroll.y < t.top - window.innerHeight / 2
                    ? 0
                    : n.instance.scroll.y > t.bottom && n.instance.scroll.y > t.bottom + 100 && t.bottom - t.top + window.innerHeight),
          ...
          },
          {
            ...
            value: function (t, e) {
              var i,
                ...
                o = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : [0.25, 0, 0.35, 1],
              ...
              var d = parseFloat(this.instance.delta.y),
                ...
                p = function (t) {
                  l ? s.setScroll(s.instance.delta.x, d + f * t) : (s.instance.delta.y = d + f * t);
                };
              (this.animatingScroll = !0), this.stopScrolling(), this.startScrolling();
              var y = Date.now();
              !(function t() {
                var e = (Date.now() - y) / n;
                1 < e ? (p(1), (s.animatingScroll = !1), 0 == n && s.update(), r && r()) : ((s.scrollToRaf = requestAnimationFrame(t)), p(o(e)));
              })();
            },
          },
          {
      ...
      o(e, [
        {
          ...
          value: function () {
            if (
              (this.smoothMobile || (this.isMobile = /Android|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) || ("MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints)),
